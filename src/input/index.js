...
import { createNamespace, isDef, isObject, addUnit, isPromise, isFunction, getPropByPath } from '../utils';
...
export default createComponent({
  ...
  watch: {
    value() {
      ...
      // this.VanField.value = this.value
  ...
  methods: {
    ...
    genInput() {
      ...
      //   //   // slot['context']['$attrs']['isSlot'] = true
    ...
    getProp(key) {
      ...
      if (this.vanField && isDef(this.vanField[key])) {
        return this.vanField[key];
      }
    },
  ...
  render() {
    ...
    return (
      <div
        class={[bem('body'), bem({ disabled: this.disabled })]}
